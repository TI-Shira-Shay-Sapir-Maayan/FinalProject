...
# קובץ פלט
output_csv = "ramon_without_move_round_1_shay.csv"
...
def calculate_amplitude_phase(csi_data):
    try:
        ...
        print(f"Error in calculate_amplitude_phase: {e}")
        return [], []  # החזרת רשימות ריקות במקרה של שגיאה
...
time.sleep(5)  # השהיה של 10 שניות
