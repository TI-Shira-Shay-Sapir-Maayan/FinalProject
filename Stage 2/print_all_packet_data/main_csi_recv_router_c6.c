...
printf("rx_seq:, %d, ", info->rx_seq);

printf("\n");

printf("CSI_DATA- " MACSTR ", s_count: %d, rssi: %d, rate: %d, timestamp: %d, sig_len: %d, rx_state: %d, channel: %d, cur_bb_format: %d, cur_single_mpdu: %d, noise_floor: %d, rxend_state: %d, second: %d, rx_channel_estimate_info_vld: %d, rx_channel_estimate_len: %d, he_siga1: %lu, he_siga2: %d, he_sigb_len: %d, is_group: %d, rxmatch0: %d, rxmatch1: %d, rxmatch2: %d, rxmatch3: %d", 
    MAC2STR(info->mac), 
